...
$sql = "INSERT INTO tbl_warga SET nama='$_POST[nama]',status='$_POST[status]',pekerjaan='$_POST[pekerjaan]',umur='$_POST[umur]'";
...
{
	echo "Gagal menginput data, karena " . mysql_error();
}
